...
check(sorted(x.name for x in config_dir.glob("*.json"))==["omalaunch.files.v1.schema.json","omalaunch.quicklinks.v1.schema.json"],"Files and Quicklinks have user configuration schemas")
